/*
 *  Test Code for Prototype of AR Game - Fraser McFarlane
 * 
 * */
...
public class AugObjectScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        distanceTextObject = GameObject.FindGameObjectWithTag("Distance_Text");
